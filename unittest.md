# Introdução ao [Teste em Python](https://realpython.com/python-testing/)
...
If you’re unsure what self is or how .assertEqual() is defined, you can brush up on your object-oriented programming with
